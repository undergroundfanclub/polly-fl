...
sudo apt install -y pulseaudio bspwm xinit conky libnotify4 fonts-firacode xorg slim vim nitrogen scrot firefox-esr wget gcc make xcb libxcb-util0-dev libxcb-ewmh-dev libxcb-randr0-dev libxcb-icccm4-dev libxcb-keysyms1-dev libxcb-xinerama0-dev libasound2-dev libxcb-xtest0-dev xdo libxcb-shape0-dev
# suckless-tools
mkdir ~/.config
